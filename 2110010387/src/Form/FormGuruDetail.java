 ...
 */
package Form;
import dataTable.dataGuruDetail;
import javax.swing.JOptionPane;
/**
 *
 * @author ACER
 */
public class FormGuruDetail extends javax.swing.JFrame {
    
    private dataGuruDetail GuruDetail;
    /**
     * Creates new form FormGuruDetail
     */
    public FormGuruDetail() {
        initComponents();
        this.setLocationRelativeTo(null);
        GuruDetail = new dataGuruDetail();
    ...
    private void initComponents() {
        ...
        txtJumlahPertemuan = new javax.swing.JTextField();
        ...
        jLabel9.setText("Jumlah Pertemuan");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(txtKodeGuru, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtJumlahPertemuan, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(44, 44, 44))
        );

        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {cmbHari, txtJamMulai, txtJamSelesai, txtJumlahPertemuan, txtKelas, txtKodeGuru, txtKodePelajaran, txtRuang, txtTanggalMulai});
    ...
    private void btnTambahDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahDataActionPerformed
        ...
        GuruDetail.insertKodeGuru(txtKodeGuru.getText());
        GuruDetail.insertKodePelajaran(Integer.valueOf(txtKodePelajaran.getText()));
        GuruDetail.insertHari(cmbHari.getSelectedItem().toString());
        GuruDetail.insertRuang(txtRuang.getText());
        GuruDetail.insertKelas(txtKelas.getText());
        GuruDetail.insertJamMulai(txtJamMulai.getText());
        GuruDetail.insertJamSelesai(txtJamSelesai.getText());
        GuruDetail.insertTanggalMulai(txtTanggalMulai.getText());
        GuruDetail.insertJumlahPertemuan(txtJumlahPertemuan.getText());
    ...
    private void btnLihatDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLihatDataActionPerformed
        // TODO add your handling code here:
        String isiArray = "Kode Guru : "+GuruDetail.getRecordKodeGuru().get(0)+
                        "\nKode Pelajaran : "+GuruDetail.getRecordKodePelajaran().get(0)+
                        "\nHari : "+GuruDetail.getRecordHari().get(0)+
                        "\nRuang : "+GuruDetail.getRecordRuang().get(0)+
                        "\nKelas : "+GuruDetail.getRecordKelas().get(0)+
                        "\nJam Mulai : "+GuruDetail.getRecordJamMulai().get(0)+
                        "\nJam Selesai : "+GuruDetail.getRecordJamSelesai().get(0)+
                        "\nTanggal Mulai : "+GuruDetail.getRecordTanggalMulai().get(0)+
                        "\nJumlah Pertemuan : "+GuruDetail.getRecordJumlahPertemuan().get(0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormGuruDetail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField txtJumlahPertemuan;
